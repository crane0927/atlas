...
最后修订: 2026-01-06
修改的原则: 
  - 原则 2: Spring Boot 版本锁定 - 降级版本至 3.5.9
  - 原则 3: Spring Cloud 生态版本 - 降级 Spring Cloud 至 2025.0.1，Spring Cloud Alibaba 至 2025.0.0.0
新增章节: 无
移除章节: 无
模板更新状态:
  - .specify/templates/plan-template.md: ⏳ 待同步
  - .specify/templates/spec-template.md: ⏳ 待同步
...
| 0.4.3 | 2026-01-06 | 新增 SQL 目录管理规范，要求涉及数据库的服务按版本管理 SQL 脚本 | 系统 |
| 0.4.4 | 2026-01-06 | 补充设计模式注释要求，明确注释必须包含设计模式名称和使用原因 | 系统 |
